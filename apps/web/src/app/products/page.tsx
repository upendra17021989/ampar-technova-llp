...
export const metadata: Metadata = { title: "Products", description: "Explore AMPAR Technova corrosion-resistant storage, process, pollution-control, piping and custom-fabrication equipment." };
